                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <form action="../controllers/validar_usuario.php" method="POST">
                                <div class="row gy-3 overflow-hidden">
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nombre"
                                                id="nombre" placeholder="Usuario" required>
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn bsb-btn-xl btn-primary" type="submit">Iniciar Sesion</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                        <a href="../pages/formulario_usuarios.php" class="link-secondary text-decoration-none">Registrarse</a>
                                        <!--  <a href="#!" class="link-secondary text-decoration-none">Recuperar Contraseña</a> >!-->
                                    </div>
                                </div>
                            </div>
                            </div>
